...
The app has some features like:
  ...
  3. Modifying the Inventory.
  4. Searching for items in the Inventory.
  5. Exporting the data as an "Excel" sheet.
  6. Importing data from Excel sheets.
(This is only the code; the application is not published.)
